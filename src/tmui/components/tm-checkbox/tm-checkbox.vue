  ...
  >
    ...
    >
      <tm-sheet
        ...
        :dark="props.dark"
        :shadow="props.shadow"
        :width="_is_checkbox ? props.size : 0"
        :height="props.size"
        :text="((!props.indeterminate && !_checked) || _disabled) && !props.outlined"
        :border="props.border"
        :borderStyle="props.borderStyle"
        :transparent="props.transparent"
        :padding="_is_checkbox ? [0, 0] : [16, 10]"
        :margin="props.margin"
        :color="_disabled ? 'white' : _checked ? props.color : props.inActiveColor"
        :round="props.round"
      ...
      >
        <template v-if="!props.closeAni">
          <tm-translate
            :duration="100"
            v-if="_checked && !props.indeterminate && _is_checkbox"
            name="zoom"
            style="line-height: 1"
          >
            <tm-icon
