...
<template>
  <view
    ...
    :style="[
      ...
      _height_real ? { height: _height + _props.hunit } : '',
...
const tmcomputed = theme({
  text: blur.value && tmcfg.value.os == "ios" && isNvue.value ? true : null,
});
